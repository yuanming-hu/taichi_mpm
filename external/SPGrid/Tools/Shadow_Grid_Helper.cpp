...
//#####################################################################
template class Shadow_Grid_Helper<float,5,2>;
template class Shadow_Grid_Helper<float,6,2>;
template class Shadow_Grid_Helper<float,5,3>;
template class Shadow_Grid_Helper<float,6,3>;
#ifndef COMPILE_WITHOUT_DOUBLE_SUPPORT
template class Shadow_Grid_Helper<double,5,2>;
template class Shadow_Grid_Helper<double,6,2>;
template class Shadow_Grid_Helper<double,5,3>;
template class Shadow_Grid_Helper<double,6,3>;
#endif
